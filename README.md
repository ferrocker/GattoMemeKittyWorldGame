# Gatto Meme Kitty World Game 

This repository contains the initial setup and the final version of Gatto Meme Kitty World Game project, including the basic project structure, necessary images, and icons.

## Overview

This project is a popular Telegram mini app,. The repository provides two branches:
